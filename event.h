...
typedef enum EVENTS {JOIN=1,BUFFERING=2,REQUEST=3, PLAYBACK=4,STALL_PLAY=5,STALL_REQ=6, TOPOLOGY=7,SHOW_TOPOLOGY=8, SHOW_MAPQUERY=9,LEAVE=10,STORE=11,REPLICATE=12, FINISHED_VIEWING=13, SHOW_CHANNELS=14} TTypeEvent;
